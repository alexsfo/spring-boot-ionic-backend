...
import com.alexsandro.cursomc.domain.PagamentoComCartao;
import com.alexsandro.cursomc.domain.Pedido;
import com.alexsandro.cursomc.domain.Produto;
import com.alexsandro.cursomc.domain.enums.EstadoPagamento;
import com.alexsandro.cursomc.domain.enums.Perfil;
...
import com.alexsandro.cursomc.repositories.EstadoRepository;
...
import com.alexsandro.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "alex.metacortech@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("Transilvânia"));
		Cliente cli2 = new Cliente(null, "Manoel Soares", "alexsandro.sfo@gmail.com", "38235397013", TipoCliente.PESSOAFISICA, pe.encode("Transilvânia"));
		cli2.addPerfil(Perfil.ADMIN);
		
		cli1.getTelefones().addAll(Arrays.asList("8127363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("81926336589", "1181965223658"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "108", "Sala 800", "Centro", "38777012", cli1, c1);
		Endereco e3 = new Endereco(null, "Avenida Norte", "564", null , "Recife", "52120590", cli2, c2);
